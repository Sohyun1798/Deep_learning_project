...
from lib.suggested.self_attention_only import SelfAttentionOnlyClassifier
...
def main(config_path):
    ...
    h = model_config['h']
    num_mhas = model_config['num_mhas']

    clf = SelfAttentionOnlyClassifier(words_embed=words_embed, out_channels=out_channels,
                hidden_size=hidden_size, cuda_device=cuda_device,
                h=h, dropout=dropout, num_mhas=num_mhas)
